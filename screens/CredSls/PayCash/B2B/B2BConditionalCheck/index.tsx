...
const fetchSenderUsrDtls = async () => {
    ...
    try {
      ...
      const SenderbizBeneficiary =accountDtl.data.getBizna.bizBeneficiary; 
      ...
      const SenderbeneficiaryType =accountDtl.data.getBizna.beneficiaryType;
          ...
          const fetchRecUsrDtls = async () => {
            ...
            try {
                const RecAccountDtl:any = await API.graphql(
                    ...
                    const RecbizBeneficiary =RecAccountDtl.data.getBizna.bizBeneficiary; 
                    ...
                    const RecbeneficiaryType =RecAccountDtl.data.getBizna.beneficiaryType;

              //start calling mutations
