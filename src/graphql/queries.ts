...
>;
export const getCompanyUrls = /* GraphQL */ `query GetCompanyUrls($AdminId: String!) {
...
` as GeneratedQuery<
  APITypes.GetCompanyUrlsQueryVariables,
  APITypes.GetCompanyUrlsQuery
>;
export const listCompanyUrls = /* GraphQL */ `query ListCompanyUrls(
  $AdminId: String
...
` as GeneratedQuery<
  APITypes.ListCompanyUrlsQueryVariables,
  APITypes.ListCompanyUrlsQuery
>;
